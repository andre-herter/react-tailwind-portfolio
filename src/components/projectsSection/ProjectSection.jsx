...
function ProjectSection() {
  return (
    <div id="projects" class="text-center mt-24 pt-24">
      <h2 class="text-3xl lg:text-5xl font-bold">Meine Projekte</h2>
      <p class="text-slate-400 mt-4 lg:mt-6 lg:text-lg">
        Hier sind einige Auszüge aus meiner Arbeit, sodass Sie sich ein Bild
        meiner Fähigkeiten und Erfahrungen machen können.
      </p>
      <div class="mt-20 grid gap-y-20 gap-x-10 md:grid-cols-2 lg:grid-cols-3">
        <div class="flex flex-col items-start text-left">
          <img
            class="w-full lg:rounded-md"
            src="/projets/1.jpg"
            alt="Projekt 1 Wetter App"
          />
          <h3 class="text-3xl font-bold mt-6 lg:mt-8">Moderne Wetter App</h3>
          <a
            class="text-blue-500 font-medium flex items-center text-lg mt-4"
            href=""
          >
          ...
          <div class="flex gap-2 mt-4 lg:mt-6 flex-wrap">
            <div class="bg-slate-700 px-2.5 py-1 rounded-xl text-xs">HTML</div>
            <div class="bg-slate-700 px-2.5 py-1 rounded-xl text-xs">
              JavaScript
            </div>
            <div class="bg-slate-700 px-2.5 py-1 rounded-xl text-xs">Vite</div>
            <div class="bg-slate-700 px-2.5 py-1 rounded-xl text-xs">SCSS</div>
            <div class="bg-slate-700 px-2.5 py-1 rounded-xl text-xs">BEM</div>
            <div class="bg-slate-700 px-2.5 py-1 rounded-xl text-xs">
              WeatherAPI
            </div>
          </div>
        ...
        <div class="flex flex-col items-start text-left">
          ...
          />
          <h3 class="text-3xl font-bold mt-6 lg:mt-8">Sushibar Tokio</h3>
          <a
            class="text-blue-500 font-medium flex items-center text-lg mt-4"
            href=""
          >
        ...
        <div class="flex flex-col items-start text-left">
          ...
          />
          <h3 class="text-3xl font-bold mt-6 lg:mt-8">Lustige Witze App</h3>
          <a
            class="text-blue-500 font-medium flex items-center text-lg mt-4"
            href=""
          >
          ...
          <div class="flex gap-2 mt-4 lg:mt-6 flex-wrap">
            ...
            <div class="bg-slate-700 px-2.5 py-1 rounded-xl text-xs">BEM</div>
            <div class="bg-slate-700 px-2.5 py-1 rounded-xl text-xs">Vite</div>
            <div class="bg-slate-700 px-2.5 py-1 rounded-xl text-xs">AJAX</div>
          </div>
          <Button
            href="#"
            className="mt-6 lg:mt:8 text-sm lg:text-base font-medium bg-blue-600 hover:bg-blue-500 rounded-lg px-5 py-3 flex items-center justify-center"
